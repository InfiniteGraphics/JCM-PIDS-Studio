  ...
  return (
    <div className="app-shell">
      <TopToolbar
        ...
        onExportProject={() => download('pids-project.json', JSON.stringify(store.project, null, 2), 'application/json')}
        onExportJs={() => {
          if (store.exportSummary.errors > 0) {
            window.alert('Export blocked. Resolve validation or compatibility errors first.');
            return;
        ...
        onExportResources={() => download('joban_custom_resources.json', store.artifacts.resourceJson, 'application/json')}
      ...
      <main className="layout">
        ...
        <aside className="sidebar inspector">
          <Tabs active="Properties" items={['Properties', 'Bindings', 'Style']} />
